	...
	for k,list in pairs(poiTags) do
		if list[Find(k)] then
			...
			class = poiClasses[v] or k
                        if class == "amenity" or class == "leisure" then class = v end -- fix for style
